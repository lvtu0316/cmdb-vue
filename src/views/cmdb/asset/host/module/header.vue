<template>
  <div class="head-container">
    ...
    <div style="display: inline-block;margin: 0px 2px;">
      <el-button-group>
        <el-button v-if="checkPermission(['admin','host_all','host_delete'])" class="filter-item" size="mini" type="primary" @click="getPtoggleSelect">全选</el-button>
        <el-button v-if="checkPermission(['admin','host_all','host_delete'])" class="filter-item" size="mini" type="danger" @click="deleteSelect">删除</el-button>
    ...
    <div style="display: inline-block;margin: 0px 8px;float: right">
      <el-button-group v-if="checkPermission(['admin','host_all'])">
        <el-button
    ...
    <el-select v-model="query.network_type" clearable placeholder="网络类型" class="filter-item" style="width: 192px" @change="toQuery">
