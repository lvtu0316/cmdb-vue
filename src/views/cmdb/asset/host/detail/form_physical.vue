      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="品牌" prop="brand">
            <el-input v-model="form_base.brand" :readonly="is_Readonly" style="width: 300px;"/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="供应商">
            <el-input v-model="form_base.supplier" :readonly="is_Readonly" style="width: 300px;"/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="机柜">
            <el-select v-model="form_base.cabinet" :disabled="is_Readonly" style="width: 300px;" placeholder="请选择">
              <el-option
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="CPU颗数">
            <el-input v-model="form_base.cpu_number" :readonly="is_Readonly" style="width: 300px;"/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="CPU核数">
            <el-input v-model="form_base.cpu_core" :readonly="is_Readonly" style="width: 300px;"/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="内存卡型号">
            <el-input v-model="form_base.memory_model" :readonly="is_Readonly" style="width: 300px;"/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="内存卡品牌">
            <el-input v-model="form_base.memory_brand" :readonly="is_Readonly" style="width: 300px;"/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="内存卡条数">
            <el-input v-model="form_base.memory_num" :readonly="is_Readonly" style="width: 300px;"/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="内存大小">
            <el-input v-model="form_base.memory_size" :readonly="is_Readonly" style="width: 300px;"/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="硬盘大小">
            <el-input v-model="form_base.disk_size" :readonly="is_Readonly" style="width: 300px;"/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="硬盘个数">
            <el-input v-model="form_base.disk_num" :readonly="is_Readonly" style="width: 300px;"/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="网卡信息">
            <el-input v-model="form_base.net_card_info" :readonly="is_Readonly" style="width: 300px;"/>
          </el-form-item>
        </el-col>
      </el-row>
