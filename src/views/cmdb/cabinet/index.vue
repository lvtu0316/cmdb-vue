    ...
    <el-row :gutter="28">
      <el-col :span="span">
        ...
        <el-table v-loading="loading" ref="tables" :data="data" highlight-current-row size="small" border style="width: 100%;" @current-change="handleCurrentChange">
          ...
          <el-table-column prop="num" label="机柜编号"/>
          <el-table-column v-if="table_show" prop="brand" label="品牌"/>
          <el-table-column v-if="table_show" prop="location" label="位置"/>
...
import { del, save, retrieve } from '@/api/cabinet'
